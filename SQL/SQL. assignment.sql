...
(30, 'Derek', 'Bell', 'Sales', 'Account Executive', 5500.00, '2020-08-16', 3, 'Boston', 'Full-time', 32, 'M');
 ...
 --Select employees from Chicago who work on full-time basis
   
    SELECT *
    FROM Employees
    WHERE location="Chicago" and employment_status="Full-time"

 --Select employees from Marketing, Sales and Finance departments
    SELECT *
    FROM Employees
    WHERE Department IN("Marketing", "Sales" and "Finance")    
